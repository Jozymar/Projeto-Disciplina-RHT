...
public class Saude implements Serializable {
    ...
    public Saude(int id, String resposta1, String resposta2, String resposta3, String resposta4, String resposta5, String resposta6, Usuario usuario) {
        this.id = id;
    ...
    public String toString() {
        return "Saude{" + "id=" + id + ", resposta1=" + resposta1 + ", resposta2=" + resposta2 + ", resposta3=" + resposta3 + ", resposta4=" + resposta4 + ", resposta5=" + resposta5 + ", resposta6=" + resposta6 + ", usuario=" + usuario + '}';
    }  
}
