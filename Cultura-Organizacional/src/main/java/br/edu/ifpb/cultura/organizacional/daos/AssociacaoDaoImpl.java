 ...
 */
@Stateless
public class AssociacaoDaoImpl implements AssociacaoDao {
    ...
    public Long consultarPorDiscordoTotalmente() {
        String jqpl1 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta1=:resposta";
        String jqpl2 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta2=:resposta";
        String jqpl3 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta3=:resposta";
        String jqpl4 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta4=:resposta";
        String jqpl5 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta5=:resposta";
        String jqpl6 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta6=:resposta";
        String jqpl7 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta7=:resposta";
        String jqpl8 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta8=:resposta";
        String jqpl9 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta9=:resposta";
        String jqpl10 = "SELECT COUNT(a) FROM Associacao a WHERE a.resposta10=:resposta";
