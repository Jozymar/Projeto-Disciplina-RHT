...
public class Envolvimento implements Serializable {
    ...
    public Envolvimento(int id, String resposta1, String resposta2, String resposta3, String resposta4, String resposta5, String resposta6, String resposta7, String resposta8, Usuario usuario) {
        this.id = id;
    ...
    public String toString() {
        return "Envolvimento{" + "id=" + id + ", resposta1=" + resposta1 + ", resposta2=" + resposta2 + ", resposta3=" + resposta3 + ", resposta4=" + resposta4 + ", resposta5=" + resposta5 + ", resposta6=" + resposta6 + ", resposta7=" + resposta7 + ", resposta8=" + resposta8 + ", usuario=" + usuario + '}';
    }
}
